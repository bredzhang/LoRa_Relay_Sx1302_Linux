...
#define DEFAULT_FREQ_HZ     470300000U
...
int main(int argc, char **argv)
{
    ...
    fa = 470600000; /* .5 Hz offset to get rounding instead of truncating */
    fb = 471400000; /* .5 Hz offset to get rounding instead of truncating */
    nb_loop = 0xffffffff;
    max_rx_pkt = 255;
    rssi_offset = -160.0;
